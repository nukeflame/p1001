...
class StockLocations extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const data = [
      {
        locName: "PHARMACY",
        description: "Pharmacy ward stock location",
        status: "Active",
        createdDate: "12-Sep-2019"
      },
      {
        locName: "OCCUPATIONAL THERAPY",
        description: "Occupational Therapy ward stock location",
        status: "Active",
        createdDate: "12-Sep-2019"
      }
    ];
